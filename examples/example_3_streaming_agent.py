...
Useful when plugging PivotCodeAgent into a custom UI (web app, TUI, WebSocket
...
async def main() -> None:
    agent = PivotCodeAgent(permission_mode="yolo", provider="litellm", model="openrouter/google/gemini-2.5-flash")
