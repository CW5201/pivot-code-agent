...
from pivotcode.agent import PivotCodeAgent, AgentState
from pivotcode.messages.types import AssistantMessage, RequestStartEvent, UserMessage
...
def _make_agent(*responses, **kwargs):
    ...
    return PivotCodeAgent(backend=provider, cwd="/tmp/test", permission_mode="yolo", **kwargs)
...
class TestCrossCutting:
    ...
    def test_max_iterations_per_turn_respected(self):
        ...
        agent = PivotCodeAgent(backend=provider, cwd="/tmp/test", permission_mode="yolo", max_iterations_per_turn=2)
