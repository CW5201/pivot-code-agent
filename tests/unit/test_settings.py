...
class TestSettings:
    ...
    def test_ensure_creates_file(self):
        """ensure_settings creates .pivot/settings.json if missing."""
        with tempfile.TemporaryDirectory() as tmpdir:
            settings = load_projects_settings_and_maybe_init(tmpdir)
            path = os.path.join(tmpdir, ".pivot", "settings.json")
    ...
    def test_load_nonexistent_returns_empty(self):
        """load_settings on a dir without .pivot/ returns empty dict."""
        with tempfile.TemporaryDirectory() as tmpdir:
    ...
    def test_load_returns_file_contents_as_is(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            alan_dir = os.path.join(tmpdir, ".pivot")
