...
from pivotcode.compact.compact_truncate import (
    REPLACEMENT_MESSAGE,
    compaction_truncate_tool_results,
)
from pivotcode.compact.compact_clear import (
    CLEARED_MESSAGE,
    compaction_clear_tool_results,
)
from pivotcode.compact.compact_auto import truncate_middle_for_ptl
...
from pivotcode.utils.tokens import estimate_message_tokens
