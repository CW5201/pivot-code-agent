"""Test message serialization (pivotcode/messages/serialization.py)."""

import pytest

from pivotcode.messages.serialization import block_to_anthropic_dict as block_to_dict, message_to_anthropic_dict as message_to_api_dict, messages_to_openai_dicts
...
from pivotcode.messages.factory import create_user_message, create_assistant_message
