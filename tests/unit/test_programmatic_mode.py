"""Tests for PivotCodeAgent's programmatic-mode flag and tool selection API."""
...
from pivotcode.providers.scripted_provider import ScriptedProvider, ScriptedResponse
...
class TestInstructionGating:
    ...
    async def test_programmatic_skips_global_and_project_instructions(
        ...
        with patch(
            "pivotcode.agent.load_global_project_instructions",
            return_value="GLOBAL",
        ) as mock_global, patch(
            "pivotcode.agent.load_project_instructions",
            return_value="PROJECT",
        ) as mock_project, patch(
            "pivotcode.agent.load_global_memory_index",
