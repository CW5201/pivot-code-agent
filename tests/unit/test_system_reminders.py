...
from pivotcode.query.loop import _build_turn_reminders, _drain_message_queue
...
class TestGitStatusNotInSystemPrompt:
    ...
    def test_environment_section_excludes_git_status(self):
        from pivotcode.prompt.system_prompt import get_environment_section
...
class TestInjectMessageIntegration:
    ...
    async def test_injected_message_reaches_model(self):
        ...
        agent = PivotCodeAgent(backend=provider, cwd="/tmp/test", permission_mode="yolo")
